...
local fd = io.open(theme.wallpaper)
if fd == nil then
    theme.wallpaper = nil
else
    io.close(fd)
...
-- {{{ Colors
theme.fg_normal  = "#DCDCCCF0"
theme.fg_focus   = "#F0DFAFF0"
theme.fg_urgent  = "#CC9393"
theme.bg_normal  = "#3F3F3FE0"
...
theme.widget_hdd                                = theme.dir2 .. "/icons/hdd.png"
theme.widget_music                              = theme.dir2 .. "/icons/note.png"
theme.widget_music_on                           = theme.dir2 .. "/icons/note_on.png"
